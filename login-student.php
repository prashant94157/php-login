<?php
  ...
  if(isset($_POST['email1']) && isset($_POST['pass1']))  
  {
    if ( strlen($_POST['email1']) < 1 || strlen($_POST['pass1']) < 1 ) {
      ...
      $stmt = $pdo->prepare('SELECT id, username  FROM student WHERE email = :em AND password = :pw');
      ...
      if ($row !== false) {
        ...
        $_SESSION['id'] = $row['id'];
        $_SESSION['role'] = 0;
        // Redirect the browser to login-student.php
  ...
  if ( isset($_POST['email']) && isset($_POST['pass']) && isset($_POST['username']) && isset($_POST['cpass'])  ) {
    if ( strlen($_POST['email']) < 1 || strlen($_POST['pass']) < 1 || strlen($_POST['username']) < 1 || strlen($_POST['cpass']) < 1) {
      ...
      return;
        ...
        $stmt = $pdo->prepare('INSERT INTO student (username, password, email) VALUES (  :fn, :ln, :em)');
...
<html lang="en">
  ...
  <body>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link" href="login-teacher.php"
                >For Teacher</a
              >
            </li>
            <li class="nav-item">
              <a class="nav-link active" href="login-student.php">For Student</a>
            </li>
          </ul>
          <form class="d-flex">
            <input
    ...
    <h1 class="text-center mt-5 mb-5">Only For Student</h1>
